...
public class HttpCallWebService {
	/**
	 * @param args
	 * @throws IOException
	...
	public static void main(String[] args) throws HttpException, IOException {
		String soapRequestData =
				...
				+ " <TrackCode>123</TrackCode>" + " <Version>123</Version>"
		...
		RequestEntity requestEntity = new InputStreamRequestEntity(is, b.length,	"application/soap+xml; charset=utf-8");
